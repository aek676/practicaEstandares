...
public class Dispositivo implements Iterable<String> {
	...
	/**
	 * Si el parámetro modelo es vacío, el modelo del dispositivo será "noModel"; en
	 * caso contrario, asignamos como atributo modelo el valor del parámetro
	 * eliminando los posibles espacios en blanco que tenga delante y detrás (haz
	 * uso del método trim())
	 * Asignamos a las diez características (haz uso de la constante
	 * Parametros.numCaracteristicas) el valor false
	...
	/**
	 * Si el número de características es distinto de la constante
	 * Parametros.numCaracteristicas se ha de lanzar una excepción (throw new
	 * RuntimeException(...))
	 * El resto exactamente igual que el constructor anterior salvo la asignación de
	 * valores a las características del dispositivo
	 * Recuerda que si el valor es '0', la característica se asigna como false; en
	 * caso contrario, true (sea el carácter que sea)
	 * 
	 * @param modelo
	...
	public Dispositivo(String modelo, String caracteristicas) {
		if (caracteristicas.length() != Parametros.numCaracteristicas)
			throw new RuntimeErrorException(null, "El número de características debe ser, exactamente, igual a 10");
